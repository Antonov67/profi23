 ...
 * Use the {@link BoardFragment1#newInstance} factory method to
...
public class BoardFragment1 extends Fragment {
    ...
    public BoardFragment1(IntPager intPager) {
    ...
    public static BoardFragment1 newInstance(String param1, String param2) {
        BoardFragment1 fragment = new BoardFragment1();
